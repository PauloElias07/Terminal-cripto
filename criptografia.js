    ...
    function gerarMapaAleatorio() {
      ...
      for (let i = 0; i < letras.length; i++) {
        mapaAleatorio[letras[i]] = shuffled[i];
      }
    }
    ...
    async function trainCrypto() {
      ...
      for (let c of ALFABETO) {
        ...
        Y.push(ALFABETO.indexOf(mapaAleatorio[c]));
      }
      ...
      document.getElementById('cryptoOutput').innerText = '✅ Modelo treinado! Digite um texto.';
    }
